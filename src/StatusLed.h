...
const uint8_t _StatusLed_state_count = 6;	//Колличество состояний
const bool _StatusLed_states[_StatusLed_state_count] = {LOW, HIGH, LOW, HIGH, LOW, HIGH};
const uint16_t _StatusLed_times[_StatusLed_state_count] = {1200, 25, 250, 25, 250, 25};
